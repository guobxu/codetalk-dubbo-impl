...
import me.codetalk.apps.xiaoma.user.mapper.FollowMapper;
...
public class FollowServiceImpl extends AbstractAppService implements FollowService {
	...
	/******************************** Service ********************************/
	static final String URI_USER_FOLLOW = "/xiaoma/api/fnd/user/follow/create";
	static final String URI_EXIST_FOLLOW = "/xiaoma/api/fnd/user/follow/exist";
	static final String URI_COUNT_FOLLOW = "/xiaoma/api/fnd/user/follow/count";
