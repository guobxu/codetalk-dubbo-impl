package me.codetalk.apps.xiaoma.auth.service.impl;
...
import me.codetalk.apps.xiaoma.auth.service.AppAuthService;
...
public class AppAuthServiceImpl extends AbstractAppService implements AppAuthService {
	...
	/*************************** App Service ***************************/
	static final String URI_APP_LOGIN = "/xiaoma/api/login";
