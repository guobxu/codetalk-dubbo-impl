...
import me.codetalk.apps.xiaoma.post.cache.CommentCache;
...
import me.codetalk.apps.xiaoma.post.mapper.CommentMapper;
...
public class CommentServiceImpl extends AbstractAppService implements CommentService {
	...
	/******************************* Service *******************************/
	static final String URI_COMMENT_CREATE = "/xiaoma/api/post/comment/create";
	static final String URI_COMMENT_LIKE = "/xiaoma/api/post/comment/like";
	static final String URI_COMMENT_DTL = "/xiaoma/api/post/comment";
